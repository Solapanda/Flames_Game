...
**[▶ Play it live](https://flames.football-panda.workers.dev)**
...
3. Save — your site will be at `https://flames.football-panda.workers.dev`
...
1. **Replace the site URL** — Search for `flames.football-panda.workers.dev` in `index.html` and replace all 6 instances with your actual domain
